...
from nova_ph2_mine.PSICHIC.wrapper import PsichicWrapper
from nova_ph2_mine.PSICHIC.psichic_utils.data_utils import virtual_screening
...
DB_PATH = str(Path(nova_ph2_mine.__file__).resolve().parent / "combinatorial_db" / "molecules.sqlite")
...
def main(config: dict):
    ...
    with ProcessPoolExecutor(max_workers=1) as cpu_executor:
        while time.time() - start < 1800:
            ...
            # Calculate improvement rate and percentage
            ...
            # Update prev_avg_score for next iteration
            ...
            # Enhanced logging similar to miner_v2.py
            print(
                ...
                f"Elite frac: {elite_frac:.2f} | Mute: {mutation_prob:.2f}"
            )
